...
- Prototype: http://localhost:5005/prototype.html
- Storybook: http://localhost:6006
- Admin-App: Expo-URL aus `npm run admin-web`
- Workout-App: Expo-URL aus `npm run workout-web`

Wenn du die fertige Storybook-Version zeigen willst, vorab bauen und statisch starten:
